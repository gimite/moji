...
describe Moji do
  ...
  describe '::type' do
    ...
    it 'maps the types' do
      expect(str.each_char.map { |chr| Moji.type(chr) }).to eq exp
    end
  end
end
